...
public class ProductoHandler {
    ...
    public Mono<ServerResponse> listar(ServerRequest request) {
        return ServerResponse.ok().contentType(MediaType.APPLICATION_JSON)  // se retorma del tipo 200 y un content Typede del tipo respuesta.
    ...
    public Mono<ServerResponse> ver(ServerRequest request){
        ...
        return service.findById(id) // se debe convertir este flujo en un ServerResponse por medio de un flatMap
                ...
                .switchIfEmpty(ServerResponse.notFound().build());  // si no existe el id se puede manejar con switchIfEmpty y con ServerResponse y un .notFound  con un cuerpo sin contenido vacio
    }
